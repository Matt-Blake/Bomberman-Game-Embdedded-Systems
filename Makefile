...
game.o: game.c ../../drivers/avr/system.h ../../drivers/avr/ir_uart.h ../../drivers/avr/system.h ../../drivers/display.h ../../drivers/navswitch.h ../../fonts/font5x7_1.h ../../utils/font.h ../../utils/pacer.h ../../utils/tinygl.h reciever.h mapGenerator.h sideSelect.h
	$(CC) -c $(CFLAGS) $< -o $@
...
game.out: game.o ir_uart.o pio.o prescale.o system.o timer.o timer0.o usart1.o display.o ledmat.o navswitch.o font.o pacer.o tinygl.o reciever.o mapGenerator.o sideSelect.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
